...
def Ranking_Vendedores():
    ...
    with row0[1]:
        ...
        atualizar_dados = container_dados.button('Carregar Dados do Phoenix', use_container_width=True, key='bt_rank')
    ...
    with row1[0]:
        ...
        periodo = st.date_input('Período', value=[] ,format='DD/MM/YYYY', key='dt_input_rank')
