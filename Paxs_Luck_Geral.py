...
def Paxs_Luck_Geral():
    ...
    def gerar_mapa_router_geral():
        ...
        mapa_router_nor = st.session_state.mapa_router_nor[(st.session_state.mapa_router_nor['Status do Servico']!='CANCELADO')].reset_index(drop=True)
        
        mapa_router_nor['Base Luck'] = 'FER'
    ...
    with row0[1]:
        ...
        atualizar_dados = container_dados.button('Carregar Dados do Phoenix', use_container_width=True, key='atualizar_dados_001')
